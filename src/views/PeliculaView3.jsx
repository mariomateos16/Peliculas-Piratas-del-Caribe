...
import titulo from '../assets/img/logopelicula3.png'
import { useNavigate } from 'react-router-dom';
import personajesPiratasDelCaribe3 from '../data/personajes.js';
      ...
      <section className='section_personajes'>
        <h1 className='titulo_detalles'>Personajes</h1>
          <div className='container_personajes'>
              {personajesPiratasDelCaribe3[2].map((personaje, index) => (
